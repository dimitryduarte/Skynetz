...
namespace Skynetz.Web
{
    public class PlanosController : Controller
    {
        ...
        {
            return View(_context.Set<Plano>().ToList());
        }
        ...
        public async Task<IActionResult> Create([Bind("Nome,Minutos,Id")] Plano plano)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Nome,Minutos,Id")] Plano plano)
        {
            if (id != plano.Id)
            {
                return NotFound();
