...
namespace Skynetz.Web
{
    public class TarifasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Origem,Destino,TarifaMinuto,Id")] Tarifa tarifa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Origem,Destino,TarifaMinuto,Id")] Tarifa tarifa)
        {
            if (id != tarifa.Id)
            {
                return NotFound();
